        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="text-center">
              <img src="./src/images/payment.jpg" alt="Payment" className="img-fluid rounded mb-4" />
              <h3>Payment</h3>
          ...
          <div className="col-lg-4">
            <div className="text-center">
              <img src="./src/images/transactions.jpg" alt="Transaction Escrow" className="img-fluid rounded mb-4" />
          ...
          <div className="col-lg-4">
            <div className="text-center">
              <img src="./src/images/securestorage.jpg" alt="Secure Storage of Funds" className="img-fluid rounded mb-4" />
